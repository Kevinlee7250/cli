...
EXPERIENCE_PATTERNS = [
    ...
    # 2026-09-20 좁힘 — "정리해봤"의 '해봤'까지 잡고 있었습니다. 조사 동사 뒤의
    # '해봤'은 글을 쓴 행위이지 겪은 일이 아닙니다(experience_audit과 같은 기준).
    (re.compile(r"(?<!정리)(?<!알아)(?<!찾아)(?<!살펴)(?<!비교)(?<!조사)(?<!계산)"
                r"(?<!검색)(?<!따져)(?<!짚어)(?<!뜯어)(?<!훑어)(?<!점검)"
                r"(해봤|써봤|가봤|먹어봤|다녀왔|살아봤|겪었|겪어봤)"), "경험 완료형"),
